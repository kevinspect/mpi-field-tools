...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseMessaging", path: "../../../node_modules/.pnpm/@capacitor-firebase+messaging@8.5.1_@capacitor+core@8.5.2_firebase@12.6.0/node_modules/@capacitor-firebase/messaging"),
        ...
        .package(name: "MpiBackgroundLocation", path: "../../../node_modules/.pnpm/@mpi+background-location@file+native-plugins+mpi-background-location_@capacitor+core@8.5.2/node_modules/@mpi/background-location")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
            dependencies: [
                ...
                .product(name: "MpiBackgroundLocation", package: "MpiBackgroundLocation")
            ]
        )
    ]
)
