const CACHE_NAME = "mpi-field-tools-shell-v193";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=193",
  "./mpi-shared.js", "./mpi-shared.js?build=193",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=193",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=193",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=193",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=193",
  "./mpi-equipment.js", "./mpi-equipment.js?build=193",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=193",
  "./admin.js", "./admin.js?build=193",
