const CACHE_NAME = "mpi-field-tools-shell-v148";
const APP_SHELL = ["./", "./index.html", "./admin.html", "./mpi-shared.js", "./mpi-shared.js?build=148", "./mpi-field-sync.js", "./mpi-field-sync.js?build=148", "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=148", "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=148", "./admin.js", "./admin.js?build=148", "./site.webmanifest", "./apple-touch-icon.png", "./icon-192.png", "./icon-512.png", "./mpi-logo.png", "./tool-thumbnails.png", "./mpi-email-template.html"];
