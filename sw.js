const CACHE_NAME = "mpi-field-tools-shell-v207";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=207",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=207", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=207",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=207",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=207",
  "./mpi-office-diagnostics.js", "./mpi-office-diagnostics.js?build=207",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=207",
  "./mpi-shared.js", "./mpi-shared.js?build=207",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=207",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=207",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=207",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=207",
  "./mpi-equipment.js", "./mpi-equipment.js?build=207",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=207",
  "./admin.js", "./admin.js?build=207",
  "./mpi-planning.js", "./mpi-planning.js?build=207",
