const CACHE_NAME = "mpi-field-tools-shell-v212";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=212",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=212", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=212",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=212",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=212",
  "./mpi-office-diagnostics.js", "./mpi-office-diagnostics.js?build=212",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=212",
  "./mpi-shared.js", "./mpi-shared.js?build=212",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=212",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=212",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=212",
  "./mpi-comment-policy.js", "./mpi-comment-policy.js?build=212",
  "./mpi-office-setup-policy.js", "./mpi-office-setup-policy.js?build=212",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=212",
  "./mpi-equipment.js", "./mpi-equipment.js?build=212",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=212",
  "./admin.js", "./admin.js?build=212",
  "./mpi-planning.js", "./mpi-planning.js?build=212",
