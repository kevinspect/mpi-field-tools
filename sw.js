const CACHE_NAME = "mpi-field-tools-shell-v150";
const APP_SHELL = ["./", "./index.html", "./admin.html", "./mpi-shared.js", "./mpi-shared.js?build=150", "./mpi-field-sync.js", "./mpi-field-sync.js?build=150", "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=150", "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=150", "./admin.js", "./admin.js?build=150", "./site.webmanifest", "./apple-touch-icon.png", "./icon-192.png", "./icon-512.png", "./mpi-logo.png", "./tool-thumbnails.png", "./mpi-email-template.html"];
