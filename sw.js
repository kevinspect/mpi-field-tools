const CACHE_NAME = "mpi-field-tools-shell-v202";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=202",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=202",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=202",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=202",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=202",
  "./mpi-shared.js", "./mpi-shared.js?build=202",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=202",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=202",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=202",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=202",
  "./mpi-equipment.js", "./mpi-equipment.js?build=202",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=202",
  "./admin.js", "./admin.js?build=202",
  "./mpi-planning.js", "./mpi-planning.js?build=202",
