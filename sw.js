const CACHE_NAME = "mpi-field-tools-shell-v120";
const APP_SHELL = ["./", "./index.html", "./admin.html", "./mpi-shared.js", "./mpi-shared.js?build=120", "./mpi-field-sync.js", "./admin.js", "./admin.js?build=120", "./site.webmanifest", "./apple-touch-icon.png", "./icon-192.png", "./icon-512.png", "./mpi-logo.png", "./tool-thumbnails.png", "./mpi-email-template.html"];
