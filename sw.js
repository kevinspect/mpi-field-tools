const CACHE_NAME = "mpi-field-tools-shell-v134";
const APP_SHELL = ["./", "./index.html", "./admin.html", "./mpi-shared.js", "./mpi-shared.js?build=134", "./mpi-field-sync.js", "./mpi-field-sync.js?build=134", "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=134", "./admin.js", "./admin.js?build=134", "./site.webmanifest", "./apple-touch-icon.png", "./icon-192.png", "./icon-512.png", "./mpi-logo.png", "./tool-thumbnails.png", "./mpi-email-template.html"];
