const CACHE_NAME = "mpi-field-tools-shell-v213";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=213",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=213", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=213",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=213",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=213",
  "./mpi-office-diagnostics.js", "./mpi-office-diagnostics.js?build=213",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=213",
  "./mpi-shared.js", "./mpi-shared.js?build=213",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=213",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=213",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=213",
  "./mpi-comment-policy.js", "./mpi-comment-policy.js?build=213",
  "./mpi-office-setup-policy.js", "./mpi-office-setup-policy.js?build=213",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=213",
  "./mpi-equipment.js", "./mpi-equipment.js?build=213",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=213",
  "./admin.js", "./admin.js?build=213",
  "./mpi-planning.js", "./mpi-planning.js?build=213",
