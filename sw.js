const CACHE_NAME = "mpi-field-tools-shell-v198";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=198",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=198",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=198",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=198",
  "./mpi-shared.js", "./mpi-shared.js?build=198",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=198",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=198",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=198",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=198",
  "./mpi-equipment.js", "./mpi-equipment.js?build=198",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=198",
  "./admin.js", "./admin.js?build=198",
  "./mpi-planning.js", "./mpi-planning.js?build=198",
