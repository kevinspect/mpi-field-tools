const CACHE_NAME = "mpi-field-tools-shell-v194";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=194",
  "./mpi-shared.js", "./mpi-shared.js?build=194",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=194",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=194",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=194",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=194",
  "./mpi-equipment.js", "./mpi-equipment.js?build=194",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=194",
  "./admin.js", "./admin.js?build=194",
