const CACHE_NAME = "mpi-field-tools-shell-v201";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=201",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=201",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=201",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=201",
  "./mpi-shared.js", "./mpi-shared.js?build=201",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=201",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=201",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=201",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=201",
  "./mpi-equipment.js", "./mpi-equipment.js?build=201",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=201",
  "./admin.js", "./admin.js?build=201",
  "./mpi-planning.js", "./mpi-planning.js?build=201",
