const CACHE_NAME = "mpi-field-tools-shell-v209";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=209",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=209", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=209",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=209",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=209",
  "./mpi-office-diagnostics.js", "./mpi-office-diagnostics.js?build=209",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=209",
  "./mpi-shared.js", "./mpi-shared.js?build=209",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=209",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=209",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=209",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=209",
  "./mpi-equipment.js", "./mpi-equipment.js?build=209",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=209",
  "./admin.js", "./admin.js?build=209",
  "./mpi-planning.js", "./mpi-planning.js?build=209",
