const CACHE_NAME = "mpi-field-tools-shell-v195";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=195",
  "./mpi-shared.js", "./mpi-shared.js?build=195",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=195",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=195",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=195",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=195",
  "./mpi-equipment.js", "./mpi-equipment.js?build=195",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=195",
  "./admin.js", "./admin.js?build=195",
  "./mpi-planning.js", "./mpi-planning.js?build=195",
