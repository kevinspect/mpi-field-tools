const CACHE_NAME = "mpi-field-tools-shell-v214";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=214",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=214", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=214",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=214",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=214",
  "./mpi-office-diagnostics.js", "./mpi-office-diagnostics.js?build=214",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=214",
  "./mpi-shared.js", "./mpi-shared.js?build=214",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=214",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=214",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=214",
  "./mpi-comment-policy.js", "./mpi-comment-policy.js?build=214",
  "./mpi-office-setup-policy.js", "./mpi-office-setup-policy.js?build=214",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=214",
  "./mpi-equipment.js", "./mpi-equipment.js?build=214",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=214",
  "./admin.js", "./admin.js?build=214",
  "./mpi-planning.js", "./mpi-planning.js?build=214",
