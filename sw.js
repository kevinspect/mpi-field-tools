const CACHE_NAME = "mpi-field-tools-shell-v205";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=205",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=205", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=205",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=205",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=205",
  "./mpi-office-diagnostics.js", "./mpi-office-diagnostics.js?build=205",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=205",
  "./mpi-shared.js", "./mpi-shared.js?build=205",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=205",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=205",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=205",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=205",
  "./mpi-equipment.js", "./mpi-equipment.js?build=205",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=205",
  "./admin.js", "./admin.js?build=205",
  "./mpi-planning.js", "./mpi-planning.js?build=205",
