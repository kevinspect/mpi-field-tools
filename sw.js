const CACHE_NAME = "mpi-field-tools-shell-v204";
const APP_SHELL = [
  "./", "./index.html", "./admin.html",
  "./mpi-app-theme.css", "./mpi-app-theme.css?build=204",
  "./mpi-office-workbench.css", "./mpi-office-workbench.css?build=204", "./brand-assets/mpi-website-header.jpg",
  "./mpi-native-bridge.js", "./mpi-native-bridge.js?build=204",
  "./mpi-office-navigation.js", "./mpi-office-navigation.js?build=204",
  "./mpi-owner-view.js", "./mpi-owner-view.js?build=204",
  "./mpi-tool-bag.js", "./mpi-tool-bag.js?build=204",
  "./mpi-shared.js", "./mpi-shared.js?build=204",
  "./mpi-field-sync.js", "./mpi-field-sync.js?build=204",
  "./mpi-subcontractor.js", "./mpi-subcontractor.js?build=204",
  "./mpi-comment-ai.js", "./mpi-comment-ai.js?build=204",
  "./mpi-equipment-images.js", "./mpi-equipment-images.js?build=204",
  "./mpi-equipment.js", "./mpi-equipment.js?build=204",
  "./mpi-equipment-admin.js", "./mpi-equipment-admin.js?build=204",
  "./admin.js", "./admin.js?build=204",
  "./mpi-planning.js", "./mpi-planning.js?build=204",
